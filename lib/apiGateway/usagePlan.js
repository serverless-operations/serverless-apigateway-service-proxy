...
module.exports = {
  compileUsagePlan() {
    if (this.serverless.service.provider.usagePlan || this.serverless.service.provider.apiKeys) {
      ...
      _.merge(this.serverless.service.provider.compiledCloudFormationTemplate.Resources, {
        [this.apiGatewayUsagePlanLogicalId]: {
          ...
          Properties: {
            ...
            UsagePlanName: `${this.serverless.service.service}-${this.provider.getStage()}`
          }
        }
      })
      if (
        _.has(this.serverless.service.provider, 'usagePlan.quota') &&
      ...
      if (
        _.has(this.serverless.service.provider, 'usagePlan.throttle') &&
