...
describe('#validateServiceProxies()', () => {
  ...
  describe('dynamodb', () => {
    ...
    it('should throw error if the "hashKey" is missing when the method is post and the action is not given', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "hashKey" fails because ["hashKey" is required when you define post "method" and not define "action" expolicitly since the hashKey value is auto-generated on AWS end]'
      )
    })
    ...
    it('should throw error if the "hashKey" is not a string when the method is post and the action is not given', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "hashKey" fails because ["hashKey" must be a string when you define post "method" and not define "action" expolicitly since the hashKey value is auto-generated on AWS end]'
      )
    })
    ...
    it('should throw error if the "action" is an invalid type given', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "action" fails because ["action" must be one of [PutItem, GetItem, DeleteItem, UpdateItem]'
      )
    })
    ...
    it('should throw error if the "hashKey" is not a string or an object', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "hashKey" fails because ["hashKey" must be a string, "hashKey" must be an object]'
      )
    })
    ...
    it('should throw error if the "hashKey" is not an attributeType', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "hashKey" fails because ["hashKey" must be a string, child "attributeType" fails because ["attributeType" is required]]'
      )
    })
    ...
    it('should throw error if the "hashKey" is a pathParam and a queryStringParam at the same time', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "hashKey" fails because ["hashKey" must be a string, key must contain "pathParam" or "queryStringParam" and only one]'
      )
    })
    ...
    it('should throw error if the "rangeKey" is not a string or an object', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "rangeKey" fails because ["rangeKey" must be a string, "rangeKey" must be an object]'
      )
    })
        ...
        apiGatewayServiceProxies: [
          {
            dynamodb: {
              ...
              method: 'put',
              hashKey: 'id',
              rangeKey: { pathParam: 'id', attributeType: 'S' }
            }
          }
        ]
      }
        ...
        apiGatewayServiceProxies: [
          {
            dynamodb: {
              ...
              method: 'put',
              hashKey: 'id',
              rangeKey: { queryStringParam: 'id', attributeType: 'S' }
            }
          }
        ]
      }
    ...
    it('should throw error if the "rangeKey" is not an attributeType', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "rangeKey" fails because ["rangeKey" must be a string, child "attributeType" fails because ["attributeType" is required]]'
      )
    })
    ...
    it('should throw error if the "rangeKey" is a pathParam and a queryStringParam at the same time', () => {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "rangeKey" fails because ["rangeKey" must be a string, key must contain "pathParam" or "queryStringParam" and only one]'
      )
    })

    it('should throw error if the "action" parameter is required when the method is other than post, get, delete, put, patch', () => {
      serverlessApigatewayServiceProxy.serverless.service.custom = {
        apiGatewayServiceProxies: [
          {
            dynamodb: {
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        'child "action" fails because ["action" is required when you define options, head, any to "method" property]'
      )
    })
