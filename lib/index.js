...
const apiKeys = require('./apiGateway/apiKeys')
const usagePlan = require('./apiGateway/usagePlan')
const usagePlanKeys = require('./apiGateway/usagePlanKeys')
    ...
    this.hooks = {
      'package:compileEvents': async () => {
        if (this.getAllServiceProxies().length > 0) {
          ...
          await this.compileApiKeys()
          await this.compileUsagePlan()
          await this.compileUsagePlanKeys()
